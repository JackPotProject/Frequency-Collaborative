...
model = FCACoAttentionNet(num_classes=2)
...
train_path = './data_set/train_720k/train'
val_path = './test'
data_train = ImageFolder(train_path, transforms_combined)
data_val = RandomValSet(val_path, 0.2, transforms_test)
...
torch.save(model.state_dict(), 'model/fca.pt')
